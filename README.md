...
this project predicts whether a call will drop based on network and user-related factors using machine learning techniques →
...
2 → run the streamlit app → streamlit run call_drop.py
